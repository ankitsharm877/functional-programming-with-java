...
public class FP02Functional {
	...
	public static void main(String[] args) {
		...
		System.err.println("Max Value: " + findMinOrMaxValue(numbers));
	...
	private static int findMinOrMaxValue(List<Integer> numbers) {
		return numbers.stream().reduce(Integer.MIN_VALUE, (x, y) -> x > y ? x : y); // max
		//return numbers.stream().reduce(Integer.MAX_VALUE, (x, y) -> x < y ? x : y); // min
	}
}
